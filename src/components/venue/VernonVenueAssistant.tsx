...
import { Bot, MessageSquare, Crown, Brain, FileSpreadsheet } from "lucide-react";
    ...
    <Card className="border-2 border-amber-300 bg-gradient-to-br from-amber-50 to-white dark:from-amber-900/50 dark:to-background">
      <CardHeader className="pb-2">
        <CardTitle className="flex items-center text-amber-800 dark:text-amber-200">
          ...
          Gemini-Powered Venue Assistant
        </CardTitle>
      </CardHeader>
      <CardContent>
        <div className="space-y-4">
          <p className="text-sm font-medium text-gray-800 dark:text-gray-100">
            Google's Gemini AI helps you manage your venue and analyze customer data with cutting-edge natural language processing.
          </p>
          
          <div className="space-y-2">
            <h4 className="text-xs font-medium uppercase text-gray-700 dark:text-gray-200">Ask Gemini about:</h4>
            <ul className="text-sm space-y-1 text-gray-800 dark:text-gray-100">
              ...
              <li className="flex items-center"><FileSpreadsheet className="mr-2 h-3 w-3 text-amber-500" /> P&L processing with Notebook LM</li>
            </ul>
          </div>
