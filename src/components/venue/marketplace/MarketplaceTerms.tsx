  ...
  return (
    <div className="space-y-4">
      <Alert className="bg-amber-50 border-amber-200 dark:bg-amber-900/20 dark:border-amber-800">
        ...
        <AlertTitle>Platform Fee Information</AlertTitle>
        <AlertDescription>
        ...
        <CardContent className="p-4 pb-2">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-center">
            <div className="p-3">
              ...
              <h3 className="text-sm font-medium mb-1">Secure Escrow</h3>
            ...
            <div className="p-3">
              ...
              <h3 className="text-sm font-medium mb-1">Simple Payments</h3>
              <p className="text-xs text-muted-foreground">
            ...
            <div className="p-3">
              <div className="flex justify-center mb-2">
                <div className="bg-amber-100 dark:bg-amber-900/50 rounded-full p-3">
                  <Check className="h-6 w-6 text-amber-600 dark:text-amber-400" />
                </div>
              </div>
              <h3 className="text-sm font-medium mb-1">Verified Content</h3>
              <p className="text-xs text-muted-foreground">
      ...
      <Accordion type="single" collapsible className="w-full">
        ...
        <AccordionItem value="cancellations">
          <AccordionTrigger>Cancellations & Disputes</AccordionTrigger>
          <AccordionContent>
            <div className="space-y-3 text-sm">
