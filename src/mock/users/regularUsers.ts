...
export const regularUsers: User[] = [
  {
    ...
    bio: "Coffee enthusiast and digital nomad. Always searching for the perfect espresso and cozy work spots. Living the remote work dream! ☕💻🌟🌍",
    verified: false,
    posts: 45,
    followers: 1250,
    following: 456,
  ...
  },
  {
    ...
    bio: "Food blogger exploring local gems. Weekend warrior and taco lover. Every meal tells a story and I'm here for all of them! 🌮🍕📸🎉",
    verified: false,
    posts: 23,
    followers: 892,
    following: 234,
  ...
  },
  {
    ...
    bio: "Photographer capturing city vibes and urban stories. Love finding hidden spots for the perfect shot. Through my lens, the world comes alive! 📷🌆✨🏙️",
    verified: false,
    posts: 67,
    followers: 3420,
    following: 789,
  ...
  },
  {
    ...
    bio: "Tech startup founder and serial entrepreneur. Always looking for great co-working spots with good wifi and vibes. Building the future! 💻🚀☕⚡",
    verified: false,
    posts: 34,
    followers: 2100,
    following: 345,
  ...
  },
  {
    ...
    bio: "Marketing professional and brunch enthusiast. Exploring the city one meal at a time. Weekends are made for bottomless mimosas! 🥐🍳🥞🥂",
    verified: false,
    posts: 52,
    followers: 1780,
    following: 567,
