...
export const allCityData = [
  barcelonaData, berlinData,
  dubaiData, istanbulData, laData, melbourneData, moscowData, mumbaiData, nycData,
  phoenixData, rioData, sanFranciscoData, saoPauloData, seoulData,
  singaporeData, sydneyData, torontoData, vegasData, romeData
];